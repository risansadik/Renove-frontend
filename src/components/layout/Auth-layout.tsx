...
export const AuthLayout = ({ children, panel }: AuthLayoutProps) => {
    return (
        <div className="min-h-screen bg-surface flex">
            <aside className="hidden lg:flex lg:w-[45%] relative overflow-hidden flex-col justify-between p-12 bg-brand-900">
                ...
                <div className="relative z-10 flex-1 flex flex-col justify-center stagger-2">
                    {panel ?? <DefaultPanel />}
                </div>

                <div className="relative z-10 text-white/30 text-xs font-body stagger-4">
            ...
            <main className="flex-1 flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
                <div className="w-full max-w-md animate-fade-up">
                    <div className="flex items-center gap-2 mb-8 lg:hidden stagger-1">
...
const DefaultPanel = () => (
    <div>
        ...
        <div className="mt-10 flex flex-col gap-4 stagger-3">
            {[
                ...
                <div key={n} className="flex items-center gap-4">
                    ...
                    <div className="w-10 h-10 rounded-xl bg-brand-500/30 border border-brand-500/40 flex items-center justify-center">
                        <span className="text-lavender-300 font-display font-bold text-sm">{n}</span>
                    </div>
