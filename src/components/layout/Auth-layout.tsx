  ...
  return (
    <div className="min-h-screen bg-surface flex">
      <aside className="hidden lg:flex lg:w-[45%] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-brand-500/10 rounded-full blur-3xl translate-x-1/3 translate-y-1/3" />
  ...
  <div>
    ...
    <div className="mt-10 flex flex-col gap-4">
      {[
        ...
        { n: "AI", label: "Emotional support companion" },
        { n: "24/7", label: "Therapist availability" },
      ].map(({ n, label }) => (
        <div key={n} className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-xl bg-brand-500/15 border border-brand-500/20 flex items-center justify-center">
            <span className="text-brand-400 font-display font-bold text-sm">{n}</span>
          </div>
