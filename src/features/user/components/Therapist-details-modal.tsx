...
import { X, Users, Star, Clock, Heart, Briefcase, GraduationCap, Calendar } from "lucide-react";
        ...
        >
          ...
          <div className="relative px-8 py-8 shrink-0" style={{ borderBottom: "1px solid var(--border-subtle)", background: "var(--accent-glow)" }}>
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
              {/* Avatar */}
              <div className="w-20 h-20 rounded-2xl flex items-center justify-center text-2xl font-display font-bold text-white flex-shrink-0"
